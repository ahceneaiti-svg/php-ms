...
/**
 * Alimente un registre Prometheus (stockage APCu) avec un compteur de
 * requetes et un histogramme de latence pour les endpoints HTTP de ce
 * service (/health, /metrics). Les metriques metier (emails envoyes) sont
 * alimentees par ConsumeUserEventsCommand, dans le meme registre partage
 * (voir docker/apcu-shared.ini).
 */
